...
from baselines.DEMIPL.dataloader import *  # 从自定义的 dataloader 模块中导入所有内容
from baselines.DEMIPL.model_manifold import *  # 从自定义的 model 模块中导入所有内容
from utils.manifold.lablemanifold import lablemanifold
from baselines.DEMIPL.utils import *  # 从自定义的 util 模块中导入所有内容
from baselines.DEMIPL.util.build_label_manifold import build_label_manifold
...
parser.add_argument('--nr_fea', type=int, default=9, help='feature dimension of an instance 实例的特征维度')
